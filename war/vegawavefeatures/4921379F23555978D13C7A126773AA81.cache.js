...
var $strongName = '4921379F23555978D13C7A126773AA81';
...
var $intern_5 = '', $intern_3 = '\n', $intern_11 = ' ', $intern_0 = 'Unknown', $intern_1 = 'Unknown source', $intern_2 = 'anonymous', $intern_7 = 'com.vegalabs.features.client.VegaWaveFeatures', $intern_6 = 'com.vegalabs.general.client.VegaGeneral', $intern_4 = 'function ', $intern_9 = 'moduleStartup', $intern_10 = 'onModuleLoadStart', $intern_8 = 'startup';
var _;
function nullMethod(){
}
...
function com_google_gwt_core_client_impl_StackTraceCreator$Collector_$createStackTrace__Lcom_google_gwt_core_client_impl_StackTraceCreator$Collector_2Lcom_google_gwt_core_client_JavaScriptException_2V(e){
  ...
  for (i = 0 , j = stackTrace.length; i < j; ++i) {
    stackTrace[i] = java_lang_StackTraceElement_$StackTraceElement__Ljava_lang_StackTraceElement_2Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2ILjava_lang_StackTraceElement_2(new java_lang_StackTraceElement, $intern_0, stack[i], $intern_1, 0);
  }
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_$inferFrom__Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorMoz_2Lcom_google_gwt_core_client_JavaScriptObject_2Lcom_google_gwt_core_client_JsArrayString_2(e){
  ...
  for (i = 0 , j = stack.length; i < j; ++i) {
    stack[i] = stack[i].length == 0?$intern_2:stack[i];
  }
  return stack;
}
...
function com_google_gwt_core_client_impl_StackTraceCreator$CollectorOpera_$getStack__Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorOpera_2Lcom_google_gwt_core_client_JavaScriptObject_2Lcom_google_gwt_core_client_JsArrayString_2(e){
  ...
  toReturn = e && e.message?e.message.split($intern_3):[];
  for (i = 0 , i2 = 0 , j = toReturn.length; i2 < j; ++i , i2 += 2) {
    idx = toReturn[i2].lastIndexOf($intern_4);
    idx == -1?(toReturn[i] = $intern_5 , undefined):(toReturn[i] = java_lang_String_$trim__Ljava_lang_String_2Ljava_lang_String_2(toReturn[i2].substr(idx + 9, toReturn[i2].length - (idx + 9))) , undefined);
  }
  toReturn.length = i;
  return toReturn;
}
...
function com_google_gwt_lang_EntryMethodHolder_init__V(){
  !!$stats && com_google_gwt_lang_Stats_onModuleStart__Ljava_lang_String_2Z($intern_6);
...
function com_google_gwt_lang_Stats_onModuleStart__Ljava_lang_String_2Z(mainClassName){
  return $stats({moduleName:$moduleName, sessionId:$sessionId, subSystem:$intern_8, evtGroup:$intern_9, millis:(new Date).getTime(), type:$intern_10, className:mainClassName});
}
...
function java_lang_String_$trim__Ljava_lang_String_2Ljava_lang_String_2(this$static){
  if (this$static.length == 0 || this$static[0] > $intern_11 && this$static[this$static.length - 1] > $intern_11) {
    return this$static;
  }
